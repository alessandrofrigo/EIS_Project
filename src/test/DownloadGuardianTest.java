...
public class DownloadGuardianTest {
     ...
     * @see DownloadGuardian
     */
    @Ignore // Il test funziona al momento della scrittura, ma gli articoli del Guardian sono ordinati per rilevanza, quindi possono cambiare posizione
    @Test
    public void testCorrectArticle(){
        DownloadGuardian d = new DownloadGuardian();
        List<String> testList = d.downloadArticles(); // 565
        d.downloadAndStore();
        assertEquals("Government spending is always contentious, with every choice made " +
                ...
                " “pay down the debt” then simply save more than you spend.", testList.get(564));
    }
